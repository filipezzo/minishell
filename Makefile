...
FRONT_FILES = build_dir_pmt.c build_home_pmt.c build_host_pmt.c build_prompt.c build_type_pmt.c build_user_pmt.c lexer.c start_prompt.c check_parentheses_rule.c check_pipe_rule.c check_redirection_rule.c syntax_error_msg.c analyze_syntax.c
