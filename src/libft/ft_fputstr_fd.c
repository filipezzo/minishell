...
/*   Updated: 2025/12/17 14:26:01 by mhidani          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * Prints a string that, when the special character `$` is indicated only once, 
 ...
 * special character flags `$`. When specified, this will indicate where it will
 ...
 * special character `$` that indicate replacement.
